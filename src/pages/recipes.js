const recipes = {
    topRated: [
        {
            ...
            rating: 4.5,
            ratingCount: 128,
            description: 'A classic Italian pasta dish with rich tomato sauce and fresh herbs.',
            ingredients: [
                { quantity: '1 pound', name: 'spaghetti' },
                { quantity: '2 cups', name: 'tomato sauce' },
                { quantity: '3 cloves', name: 'garlic', notes: 'minced' },
                { quantity: '1/4 cup', name: 'olive oil' },
                { quantity: '1/2 cup', name: 'fresh basil', notes: 'chopped' }
            ],
            instructions: [
                ...
                'Toss cooked pasta with sauce and garnish with fresh basil'
            ],
            nutritionalInfo: {
                calories: '380 kcal',
                protein: '12g',
        ...
        },
        {
            ...
            image: '../tacos.jpg',
            rating: 4.7,
            description: 'Flavorful and spicy tacos with seasoned ground beef, fresh toppings, and a zesty kick.',
            prepTime: '20 minutes',
            cookTime: '15 minutes',
            servings: 4,
            cuisine: 'Mexican',
        ...
        image: '../cakes.jpg',
        rating: 4.8,
        description: 'Soft and moist pumpkin cupcakes topped with a rich cream cheese frosting.',
        prepTime: '15 minutes',
        cookTime: '20 minutes',
        servings: 12,
        cuisine: 'American',
        ...
        ingredients: [
            ...
            { name: 'Cream cheese', quantity: '8 ounces', notes: 'softened (for frosting)' },
            { name: 'Butter', quantity: '1/2 cup', notes: 'softened (for frosting)' },
    ...
    },
    {
        ...
        image: '../pie.jpg',
        rating: 4.9,
        description: 'A classic American apple pie with a flaky crust and a spiced apple filling.',
        prepTime: '30 minutes',
        cookTime: '50 minutes',
        servings: 8,
        cuisine: 'American',
        category: 'Dessert',
        ingredients: [
            { name: 'Apples', quantity: '6 cups', notes: 'peeled, cored, and sliced' },
            { name: 'Granulated sugar', quantity: '3/4 cup' },
            ...
            { name: 'Unsalted butter', quantity: '2 tablespoons', notes: 'cut into small pieces' },
    ...
    },
    {
        ...
        image: '../lasagna.jpg',
        rating: 5.0,
        description: 'A rich and cheesy Italian lasagna layered with a savory meat sauce and creamy ricotta filling.',
        prepTime: '30 minutes',
        cookTime: '1 hour',
        servings: 8,
        cuisine: 'Italian',
        ...
        ingredients: [
            { name: 'Ground beef', quantity: '1 pound' },
            { name: 'Italian sausage', quantity: '1/2 pound', notes: 'mild or spicy' },
            ...
            { name: 'Lasagna noodles', quantity: '12', notes: 'cooked according to package instructions' },
    ...
    },
    {
        ...
        image: '../harira.jpg',
        rating: 4.8,
        description: 'A traditional Moroccan soup made with tomatoes, lentils, chickpeas, and aromatic spices.',
        prepTime: '15 minutes',
        cookTime: '1 hour',
        servings: 6,
        cuisine: 'Moroccan',
        ...
        ingredients: [
            ...
            { name: 'Chickpeas', quantity: '1 can (15 ounces)', notes: 'drained and rinsed' },
    ...
    trending: [
        ...
        image: '../curry.jpg',
        rating: 4.9,
        description: 'A hearty and flavorful vegan curry packed with vegetables, coconut milk, and aromatic spices.',
        prepTime: '15 minutes',
        cookTime: '40 minutes',
        servings: 4,
        cuisine: 'Indian',
        ...
        ingredients: [
            ...
            { name: 'Canned chickpeas', quantity: '1 can (15 ounces)', notes: 'drained and rinsed' },
        ...
        },
        {
            ...
            image: '../choco.jpg',
            rating: 5.0,
            description: 'A rich and moist chocolate cake with a creamy chocolate frosting, perfect for any occasion.',
            prepTime: '20 minutes',
            cookTime: '35 minutes',
            servings: 8,
            cuisine: 'Dessert',
        ...
        image: '../corn.jpg',
        rating: 4.7,
        description: 'Crispy and golden corn fritters made with fresh corn kernels, perfect as a snack or appetizer.',
        prepTime: '15 minutes',
        cookTime: '10 minutes',
        servings: 4,
        cuisine: 'American',
        ...
        image: '../lollipop.jpg',
        rating: 4.6,
        description: 'Crispy, cheesy bread lollipops with a golden crust, perfect for a fun snack or party appetizer.',
        prepTime: '20 minutes',
        cookTime: '10 minutes',
        servings: 6,
        cuisine: 'Fusion',
        ...
        image: '../boats.jpg',
        rating: 4.7,
        description: 'Baked sweet potatoes stuffed with a delicious mix of veggies, cheese, and spices for a healthy and flavorful meal.',
        prepTime: '15 minutes',
        cookTime: '45 minutes',
        servings: 4,
        cuisine: 'American',
        ...
        image: '../chikki.jpg',
        rating: 4.8,
        description: 'A crunchy and nutty Indian sweet made with walnuts and jaggery, perfect for a healthy energy boost.',
        prepTime: '10 minutes',
        cookTime: '15 minutes',
        servings: 10,
        cuisine: 'Indian',
    ...
    newest: [
        ...
        image: '../salad.jpg',
        rating: 4.7,
        description: 'A refreshing and vibrant salad packed with fresh fruits, greens, and a zesty dressing, perfect for hot summer days.',
        prepTime: '15 minutes',
        cookTime: '0 minutes',
        servings: 4,
        ...
        image: '../salmon.jpg',
        rating: 4.9,
        description: 'A delicious and healthy grilled salmon dish with a tangy lemon and herb marinade.',
        prepTime: '10 minutes',
        cookTime: '15 minutes',
        servings: 2,
        cuisine: 'American',
        ...
        image: '../loco.jpg',
        rating: 4.8,
        description: 'A Hawaiian comfort food classic featuring a juicy hamburger patty, rich brown gravy, and a fried egg over rice.',
        prepTime: '10 minutes',
        cookTime: '20 minutes',
        servings: 2,
        cuisine: 'Hawaiian',
        ...
        ingredients: [
            ...
            { name: 'Cornstarch', quantity: '1 teaspoon', notes: 'mixed with 2 tbsp water' },
            { name: 'Green onions', quantity: '2 tablespoons', notes: 'chopped, for garnish' }
        ],
        instructions: [
        ...
        image: '../toast.jpg',
        rating: 4.9,
        description: 'A deliciously sweet and comforting breakfast casserole made with cinnamon rolls, eggs, and a rich glaze.',
        prepTime: '10 minutes',
        cookTime: '35 minutes',
        servings: 6,
        cuisine: 'American',
        category: 'Breakfast',
        ingredients: [
            { name: 'Refrigerated cinnamon rolls', quantity: '2 cans', notes: 'with icing' },
            ...
            { name: 'Powdered sugar', quantity: '2 tablespoons', notes: 'for dusting (optional)' }
        ],
        instructions: [
        ...
        rating: 4.7,
        description: 'A traditional German dish made with seasoned ground meat, pan-fried to perfection.',
        prepTime: '15 minutes',
        cookTime: '20 minutes',
        servings: 4,
        cuisine: 'German',
        ...
        ingredients: [
            ...
            { name: 'Bread roll', quantity: '1', notes: 'soaked in water and squeezed dry' },
            { name: 'Egg', quantity: '1' },
            ...
            { name: 'Vegetable oil', quantity: '2 tablespoons', notes: 'for frying' }
        ],
        instructions: [
        ...
        image: '../jelly.jpg',
        rating: 4.8,
        description: 'A refreshing Japanese dessert made with coffee-flavored gelatin cubes served with sweet cream.',
        prepTime: '10 minutes',
        cookTime: '5 minutes',
        servings: 4,
        cuisine: 'Japanese',
        ...
        ingredients: [
            ...
            { name: 'Sweetened condensed milk', quantity: '½ cup', notes: 'or heavy cream for serving' }
        ],
        instructions: [
